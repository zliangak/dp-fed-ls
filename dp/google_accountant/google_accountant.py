...
https://github.com/tensorflow/privacy/tree/master/tensorflow_privacy/privacy
"""
...
def _compute_log_a_int(q, sigma, alpha):
  ...
  this follows from Section 3.3 Case I, in https://arxiv.org/abs/1908.10530
  """
...
def _compute_log_a_frac(q, sigma, alpha):
  ...
  This follows from Section 3.3 Case II, in https://arxiv.org/abs/1908.10530
  """
...
def _compute_eps(orders, rdp, delta):
  ...
  # this is the standard transformation from RDP to DP
...
def _compute_rdp(q, sigma, alpha):
  ...
  # relationship between RDP(epsilon) and A_alpha
...
def compute_rdp_from_ledger(ledger, orders):
  ...
  for sample in ledger:
    ...
    # The derives from Section 4 of https://arxiv.org/pdf/1812.06210.pdf
    effective_z = sum([
