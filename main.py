...
def main(args):
    ...
    if not args.debug:
        ...
        torch.save(logs, '../weights_v2/{}_val_{:.4f}_test_{:.4f}.pkl'.format(exp_name, val_acc, test_acc))
...
if __name__ == '__main__':
    ...
    #data_root = '/home/zliangak/gpu3/data/'
    #data_root = '/home/zliangak/data/'

    if 'yuany' in os.uname()[1]:
